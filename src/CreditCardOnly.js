...
export default class CreditCardOnly extends Component {
  constructor(props) {
    super(props);
    this.state = {
      firstDotActive: true
      ...
      <View style={s.mainWrapper}>
        <View style={[s.cardContainer, containerSize]}>
          <FlipCard style={{ borderWidth: 0 }}
            ...
            clickable={true}
            flip={shouldFlip}
            onFlipStart={() => this.setState({ firstDotActive: !this.state.firstDotActive})}>
        ...
        <View style={s.dots}>
          <Dot isActive={this.state.firstDotActive}/>
          <Dot isActive={!this.state.firstDotActive}/>
        </View>
      </View>
    );
